...
class Category{
    ...
    */
	 ...
	 * @return [type]         [description]
	 */
	public static function getParentsByFid($cate,$fid){
		$arr=array();
		foreach ($cate as $v) {
			if($v['id']==$fid){
				$arr[]=$v;
				$arr=array_merge($arr,self::getParentsByFid($cate,$v['fid']));
			}
		}
		$arr=array_reverse($arr);
		return $arr;
	 ...
	 * @return [type]       [description]
	 */
	public static function getChildrenForIds($cate,$id){
	 ...
	 * @return [type]         [description]
	 */
	public static function getParentsForIds($cate,$fid){
		$arr=array();
		foreach ($cate as $v) {
			if($v['id']==$fid){
				$arr[]=$v;
