...
<div class="main padd">
    ...
    <?php if(empty($vo)): ?><!-- 无物流信息 -->
        ...
        <div class="cart_pro_list">
                <!-- 商品 -->
                <?php if(is_array($vo["pro"])): $i = 0; $__LIST__ = $vo["pro"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><div class="cart_product">
                        <label>
                        ...
                        <span>
                            ...
                            <strong>
                                ...
                                <input type="number" name="num" value="<?php echo ($vo1["count"]); ?>" class="number" disabled/>
                                <input type="button" name="plus" value="+" class="jiajian plus" disabled/>
                            </strong>
                            <h2 class="red_col">￥<?php echo ($vo1["totals"]); ?></h2>
                        </span>
            ...
            <div class="user_info">
                ...
                <div class="sl_user">
                    <h3>购买人信息</h3>
                    <input type="text" name="suser" placeholder="姓名" value="<?php echo (get_info_left($vo["post_userinfo"])); ?>" disabled>
                    <input type="tel" name="sphone" placeholder="联系电话" value="<?php echo (get_info_right($vo["post_userinfo"])); ?>" disabled>
                </div>
                <!-- 收货人 -->
                <div class="sl_user">
                    <h3>收货人信息</h3>
                    ...
                    <input type="text" name="city" readonly="true" id="city" placeholder="选择省市" value="<?php echo (get_address_left($vo["post_address"])); ?>" disabled>
                    <textarea placeholder="街道信息" disabled><?php echo (get_address_right($vo["post_address"])); ?></textarea>
                </div>
            </div>
            <div class="query_info">
                <div class="query_info_title">
                    <h4>物流信息<span class="coupon_bg">产品</span></h4>
                    <h4>
                        顺丰单号/<font class="red_col"><?php echo ($vo["post_goods_express"]); ?></font>
                        <input type="checkbox" <?php if(($vo["shun_feng"]) == "0"): ?>checked<?php endif; ?> id="logistics" disabled/>
                        <label for="logistics"> <?php if(($vo["shun_feng"]) == "1"): ?>到付<?php else: ?>已付<?php endif; ?></label>
                    </h4>
                </div>
            ...
            <div class="query_info">
                <div class="query_info_title">
                    ...
                    <h4 class="gray_col2">
                        顺丰单号/<font class="red_col"><?php echo ($vo["post_goods_express"]); ?></font>
                        <input type="checkbox" checked="checked" id="logistics" disabled />
                        <label for="logistics">已付</label>
                    </h4>
                </div>
                <div class="logistics_info"></div>
            </div>
