...
<div class="main">
    <div class="main_product">
        <div class="main_product_top">
				<span>
					...
					<p><?php echo (get_pro_left($vo['pro']['description'])); ?>&nbsp;｜&nbsp;<?php echo (get_pro_right($vo['pro']['description'])); ?></p>
				</span><h2>￥<?php echo ($vo['pro']['tprice']); ?></h2>
        </div>
        <div class="product_img">
            <div class="pro_coupon small_coupon">
    ...
    <div class="product_info">
        ...
        <div class="edit_console">
            <?php echo (htmlspecialchars_decode($vo['pro']['content'])); ?>
        </div>
    </div>
    <div class="clear"></div>
</div>
