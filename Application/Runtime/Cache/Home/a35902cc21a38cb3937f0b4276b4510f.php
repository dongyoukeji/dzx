...
<div class="main">
    ...
    <div class="proudct_list small_product_list">
        <!-- 产品 -->
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="product_info small_product">
                ...
                <div class="product_price">
                    ...
                    <a href="<?php echo U('product/details?id='.$vo['id']);?>" class="raisecar raisecar_pos">查看详情</a>
                </div>
