    ...
    <div class="main_left" style="border-right: 0;">
        ...
        <div class="product_info" style="margin-top:20px;">
            ...
            <div class="product_price wine">
                ...
                <div class="clear"></div>
                <a href="javascript:void(0);" class="raisecar addcar raisecar_pos" data-id="<?php echo ($vo["id"]); ?>" data-sum="0" data-type="wine">加入购物车</a>
            </div>
        </div>
    </div>
    <!-- 主体右边 -->
...
<script src="/dzx/Public/Home/js/scroll.js"></script>
