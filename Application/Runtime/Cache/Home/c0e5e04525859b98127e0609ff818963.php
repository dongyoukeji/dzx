...
<div class="main">
    ...
    <div class="main_left" style="border-right: 0;">
        <div class="left_title" style="float: left; padding-top: 3px;">
            <b class="box_section1">礼盒专区</b>
            <i class="box_section2">BOX SECTION</i>
        </div>
        <div class="product_info" style="margin-top:20px;">
            <strong class="product_img"><img src="<?php echo ($vo["image"]); ?>"></strong>
            <div class="product_price" title="<?php echo ($vo["title"]); ?>">
                <strong>
					...
					<span>
						...
						<b><?php echo (sub_str($vo["title"],9)); ?></b>
						<u>产品规格</u>
                        <?php echo (get_pro_details($vo["description"])); ?>
					</span>
                <img src="/Public/Home/images/zhengpin.fw.png">
                <a href="javascript:void(0);" class="addcar raisecar raisecar_pos"  data-id="<?php echo ($vo["id"]); ?>" data-sum="0" data-type="<?php if(($vo["column_id"]) == "5"): ?>wine<?php else: ?>goods<?php endif; ?>">加入购物车</a>
            </div>
        </div>
    </div>
    <!-- 主体右边 -->
