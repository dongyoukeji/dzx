...
<div class="admin_r_all" style="height: 477px;">
    <div class="admin_bg_all">
        <div class="admin_bg_t">
            <a href="#" id="admin_bg_t_x">订单列表</a>
            <!--<a href="/Admin/Order/add">客服添加</a>-->
        ...
        <div class="admin_bg_b">
            <ul class="admin_bg_b_t">
                <li class="admin_bg4">订单编号</li>
                <li class="admin_bg4">用户(手机)</li>
                <!--<li class="admin_bg4">货物类型</li>-->
                <li class="admin_bg4">接收信息</li>
                <li class="admin_bg4">快递信息</li>
                <li class="admin_bg4">订单状态</li>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul>
                        <li class="admin_bg4"><?php echo ($vo["ordid"]); ?></li>
                        <li class="admin_bg4"><?php echo ($vo["phone"]); ?></li>
                        ...
                        <li class="admin_bg4">
                            <a href="/Admin/Order/see?id=<?php echo ($vo["id"]); ?>">查看</a>
                            <!--<a href="/Admin/Order/add?id=<?php echo ($vo["id"]); ?>">编辑</a>-->
                            <a href="/Admin/Order/del?id=<?php echo ($vo["id"]); ?>" class="confirm" data-role="您确定要删除吗？删除后数据将不能恢复！">删除</a>
                        </li>
