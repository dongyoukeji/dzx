...
<div class="admin_r_all" style="height: 555px;">
    ...
    <div class="admin_bg_all">
        <div class="admin_bg_t">
            <a href="#" id="admin_bg_t_x">栏目列表</a>
            <a href="/Admin/Column/add">添加栏目</a>
        ...
        <div class="admin_bg_b">
            <ul class="admin_bg_b_t">
                <li class="admin_bg2">ID</li>
                <li class="admin_bg4">中文名称</li>
                <li class="admin_bg4">英文名称</li>
                <li class="admin_bg4">关键词</li>
                <li class="admin_bg4">简介</li>
                <li class="admin_bg2">类型</li>
                <li class="admin_bg3">状态</li>
            ...
            <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul>
                        ...
                        <li class="admin_bg4"  style="text-align: left; text-indent:<?php echo $vo['level']*15; ?>px;"><?php echo ($vo["html"]); echo ($vo["title"]); ?></li>
                        ...
                        <li class="admin_bg2"><?php echo (get_column_type($vo["type"])); ?></li>
                        <li class="admin_bg3"> <?php if(($vo["status"]) == "0"): ?><b class="green">正常</b><?php else: ?><b class="red">禁用</b><?php endif; ?>  </li>
                        <li class="admin_bg1">
                            <a href="/Admin/Column/add?gid=<?php echo ($vo["id"]); ?>">编辑</a>
                            <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Column/status?id=<?php echo ($vo["id"]); ?>&t=1" class="check-status">禁用</a>
                                <?php else: ?>
                                <a href="/Admin/Column/status?id=<?php echo ($vo["id"]); ?>&t=0" class="check-status">启用</a><?php endif; ?>
                            <a href="/Admin/Column/del?id=<?php echo ($vo["id"]); ?>" class="confirm" data-role="您确定要删除文档吗？删除后将不能恢复。">删除</a>
                        </li>
