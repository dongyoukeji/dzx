...
<div class="admin_r_all" style="height: 477px;">
    <div class="admin_bg_all">
        ...
        <form action="/Admin/Goods/addhd" method="post" enctype="multipart/form-data">
            <div class="admin_bg_fb">
                    ...
                    <span>
                        <em>单号</em>
                        <input type="text" name="post_goods_express" id="post_goods_express" placeholder="请输入单号" value="<?php echo ($oder["post_goods_express"]); ?>" class="required">
                    </span>
                    <span>
                        <em>产品信息</em>
