...
class Images {
     ...
     * @return void
     */
    static public function water($source, $water, $savename=null, $posX='', $posY='',$alpha=80) {
        //检查文件是否存在
     ...
     * @static
     * @access public
     * @param string $string  水印字符串
     * @param string $dst_path  原图片文件名
	 * @param string $filename  生成的新文件名
     * @param string $font  文字字体
     * @return string
     */
	static function stringWater($dst_path,$string1,$font,$x = 10,$y = 10,$string2='',$string3=''){
		...
		imagefttext($dst, 16, 0, $x, $y, $black, $font, $string1);
		imagefttext($dst, 15, 0, 373, 120, $black, $font, $string2.' 代言');
		imagefttext($dst, 20, 0, 293, 1035, $black, $font, $string3);
		
		//输出图片
		list($dst_w, $dst_h, $dst_type) = getimagesize($dst_path);
		//@Image::output($dst, 'jpg', $dst_path);return;
		switch ($dst_type) {
			case 1://GIF
        ...
        static function stringWater1($dst_path,$string1,$font,$x = 10,$y = 10,$fontsize=16){
		...
		$black = imagecolorallocate($dst, 0x00, 0x00, 0x00);//字体颜色
		imagefttext($dst, $fontsize, 0, $x, $y, $black, $font, $string1);
	...
	static function stringWater2($dst_path,$string1,$font,$x = 10,$y = 10){
		...
		$black = imagecolorallocate($dst, 0xFF, 0xFF, 0x00);//字体颜色
		imagefttext($dst, 16, 0, $x, $y, $black, $font, $string1);
