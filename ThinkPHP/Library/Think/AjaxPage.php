...
class AjaxPage {
	...
	protected $config = array('header'=>'条记录','prev'=>' 《 ','next'=>' 》 ','first'=>'第一页','last'=>'最后一页','theme'=>'%upPage% %first% %prePage% %linkPage% %nextPage% %end% %ajax% %downPage% ');
	// 默认分页变量名
	protected $varPage;
	//分页外层div的id
	protected $pagesId;
	...
	*/
	public function show() {
		...
		/**
		 * <div class="page">
         <div class="scott"><span class="disabled"> 上一页 </span><a href="#"> 下一页 </a><span class="current">1</span><a href="#">2</a><a href="#">3</a><a href="#">4</a><a href="#"> 下5页 </a><a href="#">最后一页</a></div> 
      </div>
		 */
		//上下翻页字符串
		...
		if($this->totalPages > 1){
			if ($upRow>0){
				$upPage = "<div class=\"page\"><div class=\"scott\"><a class='up' href='".str_replace('__PAGE__',$upRow,$url)."'>".$this->config['prev']."</a>";
			}else{
				$upPage = "<div class=\"page\"><div class=\"scott\"><span class='disabled'> 《 </span>";
			}
			
			if ($downRow <= $this->totalPages){
				$downPage = "<a class='down' href='".str_replace('__PAGE__',$downRow,$url)."'>".$this->config['next']."</a></div></div>";
			}else{
				$downPage = "<span class='disabled'> 》 </span></div></div>";
			}
		}
